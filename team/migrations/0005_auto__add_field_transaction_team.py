...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Transaction.team'
        db.add_column(u'team_transaction', 'team',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['team.Team'], blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Transaction.team'
        db.delete_column(u'team_transaction', 'team_id')
    ...
    models = {
        ...
        u'league.league': {
            ...
            'draft_current': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "u'draft_league'", 'null': 'True', 'to': u"orm['team.Team']"}),
        ...
        u'team.transaction': {
            ...
            'team': ('django.db.models.fields.related.ForeignKey', [], {'default': "''", 'to': u"orm['team.Team']", 'blank': 'True'})
        }
    }
