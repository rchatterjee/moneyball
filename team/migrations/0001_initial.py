...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'team_team', (
            ...
            ('vendor_team_id', self.gf('django.db.models.fields.CharField')(max_length=30, blank=True)),
            ('vendor_user_id', self.gf('django.db.models.fields.CharField')(max_length=40)),
            ('team_name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('waiver_priority', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('division', self.gf('django.db.models.fields.CharField')(max_length=10, null=True)),
            ('is_commisionar', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('draft_pick_number', self.gf('django.db.models.fields.IntegerField')(default=-1, null=True)),
        ))
    ...
    models = {
        ...
        u'team.team': {
            ...
            'division': ('django.db.models.fields.CharField', [], {'max_length': '10', 'null': 'True'}),
