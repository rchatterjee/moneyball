...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'team_transaction', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('action', self.gf('django.db.models.fields.CharField')(max_length=4)),
            ('player1', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['team.FantasyPlayer'], null=True, blank=True)),
        ))
        db.send_create_signal(u'team', ['Transaction'])

        # Adding field 'FantasyPlayer.rank'
        db.add_column(u'team_fantasyplayer', 'rank',
                      self.gf('django.db.models.fields.IntegerField')(default=0, null=True),
                      keep_default=False)

        # Deleting field 'Team.is_commisionar'
        db.delete_column(u'team_team', 'is_commisionar')

        # Adding field 'Team.is_commissioner'
        db.add_column(u'team_team', 'is_commissioner',
        ...
        # Changing field 'Team.image_name'
        db.alter_column(u'team_team', 'image_name', self.gf('django.db.models.fields.CharField')(max_length=15, null=True))

    def backwards(self, orm):
        # Deleting model 'Transaction'
        db.delete_table(u'team_transaction')

        # Deleting field 'FantasyPlayer.rank'
        db.delete_column(u'team_fantasyplayer', 'rank')

        # Adding field 'Team.is_commisionar'
        db.add_column(u'team_team', 'is_commisionar',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Team.is_commissioner'
        db.delete_column(u'team_team', 'is_commissioner')
        ...
        # Changing field 'Team.image_name'
        db.alter_column(u'team_team', 'image_name', self.gf('django.db.models.fields.CharField')(max_length=5, null=True))
    ...
    models = {
        ...
        u'team.team': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image_name': ('django.db.models.fields.CharField', [], {'default': "'0.jpg'", 'max_length': '15', 'null': 'True', 'blank': 'True'}),
            'is_commissioner': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        u'team.transaction': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'player1': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['team.FantasyPlayer']", 'null': 'True', 'blank': 'True'})
        }
    }
