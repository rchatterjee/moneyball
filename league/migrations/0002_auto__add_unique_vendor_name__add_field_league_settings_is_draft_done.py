...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Vendor', fields ['name']
        db.create_unique(u'league_vendor', ['name'])

        # Adding field 'League_Settings.is_draft_done'
        db.add_column(u'league_league_settings', 'is_draft_done',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Removing unique constraint on 'Vendor', fields ['name']
        db.delete_unique(u'league_vendor', ['name'])

        # Deleting field 'League_Settings.is_draft_done'
        db.delete_column(u'league_league_settings', 'is_draft_done')
