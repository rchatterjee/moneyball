...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'League.draft_current'
        db.add_column(u'league_league', 'draft_current',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'draft_league', null=True, to=orm['team.Team']),
                      keep_default=False)

        # Adding field 'League.draft_timeout'
        db.add_column(u'league_league', 'draft_timeout',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'League.draft_current'
        db.delete_column(u'league_league', 'draft_current_id')

        # Deleting field 'League.draft_timeout'
        db.delete_column(u'league_league', 'draft_timeout')
    ...
    models = {
        ...
        u'league.league': {
            ...
            'draft_current': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'draft_league'", 'null': 'True', 'to': u"orm['team.Team']"}),
            'draft_timeout': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'league.league_settings': {
            ...
            'count_TE_max': ('django.db.models.fields.IntegerField', [], {'default': '3'}),
            'count_TE_min': ('django.db.models.fields.IntegerField', [], {'default': '1'}),
